...
public class WifiAdmin {
    ...
    private WifiConfiguration createWifiInfo(String SSID, String Password,
        ...
        config.SSID = "\"" + SSID + "\"";
        if (Type == WifiConnect.WifiCipherType.WIFICIPHER_NOPASS || TextUtils.isEmpty(Password)) {
//            config.hiddenSSID = true;
    ...
    public boolean connectSpecificAP(String ssid) {
        ...
        for (WifiConfiguration w : list) {
            ...
            if (w.BSSID != null && w.SSID.equals(ssid)) {
        ...
        if (!networkInSupplicant) {
            WifiConfiguration config = createWifiInfo(ssid, "",null);
    ...
    public WifiConfiguration CreateWifiInfo(ScanResult scan, String Password) {
        ...
        config.status = WifiConfiguration.Status.ENABLED;
        if (scan == null || scan.capabilities == null)
            return null;
